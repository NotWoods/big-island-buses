...
import { Stop, Route, Trip } from '../common/api-types';
...
/**
 * Helper for event handlers to check if the clicked item is a nav link.
 * @param evt Click event
 * @returns The clicked nav link, or null if a nav link was not the clicked element.
 */
