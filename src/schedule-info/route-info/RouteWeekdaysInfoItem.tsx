...
import { Weekdays } from '../../common/api-types';
import { WEEKDAY_NAMES } from '../../common/parse-date';
...
/**
 * Info item that displays the days of the week that a bus will be running on.
 */
export const RouteWeekdaysInfoItem: FunctionalComponent<Props> = props => (
    <InfoItem
        id="week-days"
