...
interface Props {
    readonly firstStop?: Pick<Stop, 'stop_id' | 'name'>;
    readonly lastStop?: Pick<Stop, 'stop_id' | 'name'>;
}

/**
 * Info item that displays the first and last stop of the route.
 */
export const RouteLocationInfoItem: FunctionalComponent<Props> = props => {
    return (
        <InfoItem
            id="place"
